...
describe("Shapes", () => {
  describe("render triangle", () => {
    it("Should return the appropiate template literal", () => {
      const triangle = new Shapes.Triangle("blue", "SVG", "white");
  ...
  describe("render square", () => {
    it("Should return the appropiate template literal", () => {
      const square = new Shapes.Square("red", "SVG", "blue");
      expect(square.render())
        .toMatch(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">

    <rect width="200" height="200" fill='red' />
  
    <text x="100" y="125" font-size="60" text-anchor="middle" fill="blue">SVG</text>
  ...
  describe("render circle", () => {
    it("Should return the appropiate template literal", () => {
      const circle = new Shapes.Circle("green", "SVG", "yellow");
